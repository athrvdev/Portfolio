...
const About = () => {
  ...
  return (
    ...
    <h3 className="text-3xl mb-10 text-center font-bold tracking-tighter sm:text-5xl">
         <BlurFade delay={0.6} inView={true}><span className=''>This is me...
          </span>
          </BlurFade>
        </h3>
      ...
      <div className="relative flex h-fit min-h-[700px] w-full flex-col items-center justify-center mt-[20vh] overflow-hidden rounded-lg bg-background">
      ...
      <ul className="list-none flex justify-center mb-8 gap-4 h-fit text-indigo-500">
            <BoxReveal boxDelay={0.4} slideDelay={0.4} boxColor={darkMode ? "#5046e6" : "#181818a9"} duration={0.5}>
              <a target="_blank" rel="noopener noreferrer" className="hover:text-indigo-500 transition-colors" href={'https://github.com/athrvdev'}>GitHub</a>
              </BoxReveal>
...
<BlurFade className="flex flex-col items-center text-center space-y-4" delay={0.2} inView={true}>
